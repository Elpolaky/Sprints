...
enu_Ext_intErrorStatus error_status = EXT_INT_OK ;

/***************************************************/
//			 EXTERNAL INTERRUPT INIT
/***************************************************/
enu_Ext_intErrorStatus ExtInt_init(){
...
enu_Ext_intErrorStatus INT0_SetCallback(void(*callback)(void)){
...
enu_Ext_intErrorStatus INT1_SetCallback(void(*callback)(void)){
...
enu_Ext_intErrorStatus INT2_SetCallback(void(*callback)(void)){
